...
describe('reactionWithManualTrigger ', function () {
    it('is triggered by change in result of expression passed', function () {
        var autoMarker = '555777';
        var autoArgs = mobx_1.observable({
            marker: ''
        });
        var captured;
        var disposer = index_1.reactionWithManualTrigger(function () { return autoArgs.marker; }, function (auto, manual) {
    ...
    it('can be triggered manually', function () {
        ...
        var captured;
        var trigger = index_1.reactionWithManualTrigger(function () { return autoArgs.marker; }, function (auto, manual) {
            captured = [auto, manual];
        });
        chai_1.expect(captured).to.equal(undefined);
    ...
    it('passes IReactionPublic to expression and effect', function () {
        ...
        index_1.reactionWithManualTrigger(function (r) {
            captured[0] = r;
            return autoArgs.marker;
        }, function (auto, manual, r) {
            captured[1] = r;
        });
